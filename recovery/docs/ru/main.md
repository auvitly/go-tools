...
> Если контекст был завершен, обработка паники завершится, выполнив обогащение ошибки, переданной
> в методы `On` или `OnError`.
>
> Ошибки синхронных и асинхронных обработчиков агреггируются только в период жизни контекста. 
> Если контекст будет завершен, то результат выполнения обработчиков не будет обработан.
